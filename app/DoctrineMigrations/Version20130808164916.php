...
class Version20130808164916 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE `proofpilot`.`participant_survey_link` ADD COLUMN `survey_data` TEXT NULL AFTER `save_id`;");
    ...
    public function down(Schema $schema)
    {
        ...
        $this->abortIf($this->connection->getDatabasePlatform()->getName() != "mysql");
        $this->addSql("ALTER TABLE `proofpilot`.`participant_survey_link`.`participant` DROP COLUMN `save_id`");
