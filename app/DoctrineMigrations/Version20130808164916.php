...
class Version20130808164916 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("INSERT INTO `proofpilot`.`intervention`(`language_id`,`intervention_name`,`intervention_type_id`, `intervention_url`, `sid_id`, `intervention_response_url`, `status_id`) VALUES (1, 'SexPro Baseline Survey',2, 'http://limesurvey.dev1.proofpilot.net/index.php/survey/index/sid/865791/lang/en', 865791, NULL, 1);
