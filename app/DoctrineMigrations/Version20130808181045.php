...
class Version20130808181045 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE `proofpilot`.`participant` MODIFY COLUMN `country_id`  int(10) UNSIGNED NULL AFTER `participant_zipcode`,
    ...
    public function down(Schema $schema)
    {
        ...
        $this->abortIf($this->connection->getDatabasePlatform()->getName() != "mysql");
        $this->addSql("ALTER TABLE `proofpilot`.`participant` MODIFY COLUMN `sex_id`  int(10) UNSIGNED NULL AFTER `city_id`,
                                                              MODIFY COLUMN `race_id`  int(10) UNSIGNED NULL AFTER `sex_id,
