        ...
        if ($request->getMethod() == 'POST') {
            ...
            if ($form->isValid()) {
                ...
                if($form->get('userNameConfirm')->isClicked()) {
                    ...
                    $em->flush();
                    $parameters['message'] = $this->get('translator')->trans("username_change", array(), "general_settings", $parameters['locale']);
                    ...
                    $sms = $this->get('sms');
                    $message = $this->getContainer()->get('translator')->trans('sms_password_text', array(), "general_settings",  $parameters['locale']);
                    ...
                    if($sentSms) {
                        ...
                        $parameters['message'] = $this->get('translator')->trans("confirm_sms_send", array(), "general_settings", $parameters['locale']);
                    }
                    ...
                    if ($session->has('newPassword')) {
                        ...
                        $em->flush($participant);
                        $session->invalidate();
                        $parameters['message'] = $this->get('translator')->trans("password_change", array(), "general_settings", $parameters['locale']);
                    }
                    ...
                    $cc->sendMail($participant->getParticipantEmail(),
                            ...
                            true,
                            $parameters);
                    $parameters['message'] = $this->get('translator')->trans("email_change", array(), "general_settings", $parameters['locale']);
                } elseif ($form->get('phoneSendSMS')->isClicked()) {
                    $participantSMSCode = CyclogramCommon::getAutoGeneratedCode(4);
                    $participant->setParticipantMobileSmsCode($participantSMSCode);
                    
                    $sms = $this->get('sms');
                                        $message = $this->getContainer()->get('translator')->trans('sms_phone_text', array(), "general_settings",  $parameters['locale']);
                    $sentSms = $sms->sendSmsAction( array('message' => $message.' '.$participantSMSCode, 'phoneNumber'=>$participant->getParticipantMobileNumber()) );
                    if($sentSms) {
                        $session = $request->getSession();
                    ...
                    if ($session->has('newPhoneNumber')) {
                        ...
                        $em->flush($participant);
                        $session->invalidate();
                        $parameters['message'] = $this->get('translator')->trans("mobile_number_change", array(), "general_settings", $parameters['locale']);
                    }
                } elseif($form->get('incentiveEmailConfirm')->isClicked()) {
                        $participant->setParticipantAppreciationEmail($data['newIncentiveEmail']);
                        $em->persist($participant);
                        $em->flush($participant);
                        $parameters['message'] = $this->get('translator')->trans("appreciation_email_change", array(), "general_settings", $parameters['locale']);
                }
            } 
            else {
               if($form->get('userNameConfirm')->isClicked()) {
