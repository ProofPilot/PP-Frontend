...
class  SimpleRegistrationController extends Controller{
    ...
    public function simpleRegStep2Action($id, $studyId)
    {
        ...
        if( $request->getMethod() == "POST" ){
            ...
            if( $form->isValid() ) {
                ...
                return $this->render('CyclogramFrontendBundle:SimpleRegistration:mobile_phone_verification.html.twig', array('phone' => $participant->getParticipantMobileNumber(), 'id' => $participant->getParticipantId(), 'studyId' => $studyId, 'bgimage' => $bgimage, 'studyLogo'=>$studyLogo));
            }
        }
        return $this->render('CyclogramFrontendBundle:SimpleRegistration:mobile_phone.html.twig', array("form" => $form->createView(), 'id' => $id, 'studyId' => $studyId, 'bgimage' => $bgimage, 'studyLogo'=>$studyLogo));
    }
    ...
    public function simpleRegStep3Action($id, $studyId)
    {
        ...
        return $this->render('CyclogramFrontendBundle:SimpleRegistration:mobile_phone_verification.html.twig', array('bgimage' => $bgimage,'phone' => $customerMobileNumber, 'studyId' => $studyId ));
    }
    ...
    public function simpleRegStep5Action($id, $studyId)
    {
        ...
        return $this->render('CyclogramFrontendBundle:SimpleRegistration:mobile_phone_sms.html.twig', array('bgimage' => $bgimage,'error' => $error, 'form' => $form->createView(), 'id' => $participant->getParticipantId(), 'studyId' => $studyId, 'nPic'=>$nPic, 'studyLogo'=>$studyLogo));
    }
