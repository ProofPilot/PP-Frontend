...
class DoItNotificationCommand extends ContainerAwareCommand
{
    ...
    private function sendDoItNowEmail($participant, $interventionCode = null) 
    {
        ...
        if(isset($interventionCode))
            $interventionLinks = $em->getRepository('CyclogramProofPilotBundle:ParticipantInterventionLink')->getNotSendParticipantInterventionLinks($participant,'email', $interventionCode);
        else
    ...
    private function sendDoItNowSMS($participant, $interventionCode = null) {
        ...
        $em = $this->getContainer()->get('doctrine')->getManager();
                ...
                if(isset($interventionCode))
            $interventionLinks = $em->getRepository('CyclogramProofPilotBundle:ParticipantInterventionLink')->getNotSendParticipantInterventionLinks($participant,'sms', $interventionCode);
        else
