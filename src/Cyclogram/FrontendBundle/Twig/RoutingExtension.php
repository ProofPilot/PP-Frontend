...
/*
 * Reworked extension to support studyId passing
 */
...
class RoutingExtension extends \Twig_Extension
{
    ...
    public function getFunctions()
    {
        return array(
            ...
            'path' => new \Twig_Function_Method($this, 'getPath', array('needs_context'=>true, 'is_safe_callback' => array($this, 'isUrlGenerationSafe'))),
        );
    }
