...
/**
 * LimeOldSurvey55317320130531165519
 *
 * @ORM\Table(name="lime_old_survey_553173_20130531165519")
 * @ORM\Entity
 */
class LimeOldSurvey55317320130531165519
{
    /**
     * @var integer
     *
     ...
     * @var string
     *
     * @ORM\Column(name="553173X46X1635", type="text", nullable=true)
     */
    private $553173x46x1635;

    /**
     * @var float
     *
     * @ORM\Column(name="553173X46X1636", type="decimal", nullable=true)
     */
    private $553173x46x1636;

    /**
     * @var string
     *
     * @ORM\Column(name="553173X46X1693", type="text", nullable=true)
     */
    private $553173x46x1693;

    /**
     * @var string
     *
     * @ORM\Column(name="553173X46X1695", type="text", nullable=true)
     */
    private $553173x46x1695;
