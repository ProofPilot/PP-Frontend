...
/**
 * LimeOldSurvey72989120130603140840
 *
 * @ORM\Table(name="lime_old_survey_729891_20130603140840")
 * @ORM\Entity
 */
class LimeOldSurvey72989120130603140840
{
    /**
     * @var integer
     *
     ...
     * @var string
     *
     * @ORM\Column(name="729891X129X1719SQ008", type="string", length=5, nullable=true)
     */
    private $729891x129x1719sq008;

    /**
     * @var string
     *
     * @ORM\Column(name="729891X129X1719SQ006", type="string", length=5, nullable=true)
     */
    private $729891x129x1719sq006;

    /**
     * @var string
     *
     * @ORM\Column(name="729891X129X1719SQ007", type="string", length=5, nullable=true)
     */
    private $729891x129x1719sq007;

    /**
     * @var float
     *
     * @ORM\Column(name="729891X130X1720", type="decimal", nullable=true)
     */
    private $729891x130x1720;
     ...
     * @var string
     *
     * @ORM\Column(name="729891X132X1729", type="text", nullable=true)
     */
