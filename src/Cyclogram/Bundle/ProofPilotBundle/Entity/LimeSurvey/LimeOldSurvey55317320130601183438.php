...
/**
 * LimeOldSurvey55317320130601183438
 *
 * @ORM\Table(name="lime_old_survey_553173_20130601183438")
 * @ORM\Entity
 */
class LimeOldSurvey55317320130601183438
{
    /**
     * @var integer
     *
     ...
     * @var string
     *
     * @ORM\Column(name="553173X126X539", type="string", length=1, nullable=true)
     */
    private $553173x126x539;
     ...
     * @var float
     *
     * @ORM\Column(name="553173X127X1636", type="decimal", nullable=true)
     */
    private $553173x127x1636;

    /**
     * @var string
     *
     * @ORM\Column(name="553173X127X1693", type="text", nullable=true)
     */
    private $553173x127x1693;

    /**
     * @var string
     *
     * @ORM\Column(name="553173X127X1695", type="text", nullable=true)
     */
    private $553173x127x1695;
