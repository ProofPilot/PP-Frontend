...
use Cyclogram\SexProBundle\Form\RegistrationForm;
...
//                 return $this->redirect( $this->generateUrl("reg_step_3") );
                return $this->render('CyclogramSexProBundle:Registration:mobile_phone_2.html.twig', array('phone' => $participant->getParticipantMobileNumber()));
            }
        }
        return $this->render('CyclogramSexProBundle:Registration:mobile_phone_1.html.twig', array("form" => $form->createView()));
    }
    ...
    public function checkPhoneAction()
    {
        ...
        return $this->render('CyclogramSexProBundle:Registration:mobile_phone_2.html.twig', array('phone' => $phoneNumber));
    }
    ...
    public function enterSMSAction()
    {
        ...
        return $this->render('CyclogramSexProBundle:Registration:mobile_phone_3.html.twig', array('error' => $error, 'form' => $form->createView()));
    }
